...
module.exports = (env, argv) => {
  ...
  // Base plugins array with ESLint
  const plugins = [new ESLintPlugin()];

  // Only add obfuscator in production mode
  if (isProduction) {
    plugins.push(
      new WebpackObfuscator(
        ...
        [
          // Exclude webpack runtime and node_modules from obfuscation
          // Everything else (your bundled code) WILL be obfuscated
        ],
      ),
    );
  }
