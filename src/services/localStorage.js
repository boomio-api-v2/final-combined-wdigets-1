...
class LocalStorageService {
  ...
  getDefaultConfig() {
    ...
    const business_name =
      config?.business_name === 'Gamtos Ateitis Random' ? ['Gamtos Ateitis Glass', 'Gamtos Ateitis Plastic', 'Gamtos Ateitis Paper'][Math.floor(Math.random() * 3)] : (config?.business_name ?? 'Toni');
