function CScenario() {
  ...
  if (SHOW_3D_RENDER) var _oDemo = new CANNON.Demo();
  ...
  this._init = function () {
    ...
    var oWallBallCm = new CANNON.ContactMaterial(_oBallMaterial, _oWallMaterial, {
      friction: 0.1,
      restitution: 0.01,
    });

    var oGroundBallCm = new CANNON.ContactMaterial(_oBallMaterial, _oGroundMaterial, {
      friction: 0.2,
      restitution: 0.3,
    });
  ...
  this._createGoal = function () {
    _oPoleGoalShapeLeftRight = new CANNON.Cylinder(POLE_RIGHT_LEFT_SIZE.radius_top, POLE_RIGHT_LEFT_SIZE.radius_bottom, POLE_RIGHT_LEFT_SIZE.height, POLE_RIGHT_LEFT_SIZE.segments);
    _oGoalBodyPoleLeftRight = new CANNON.Body({ mass: 0 });
    _oPoleGoalShapeUp = new CANNON.Cylinder(POLE_UP_SIZE.radius_top, POLE_UP_SIZE.radius_bottom, POLE_UP_SIZE.height, POLE_UP_SIZE.segments);
  ...
  this.createBackGoalWall = function () {
    ...
    _oGoalShapeLeftRightWall = new CANNON.Box(new CANNON.Vec3(LEFT_RIGHT_WALL_GOAL_SIZE.width, LEFT_RIGHT_WALL_GOAL_SIZE.depth, LEFT_RIGHT_WALL_GOAL_SIZE.height));
    _oGoalShapeUpWall = new CANNON.Box(new CANNON.Vec3(UP_WALL_GOAL_SIZE.width, UP_WALL_GOAL_SIZE.depth, UP_WALL_GOAL_SIZE.height));
  ...
  this._createBallBody = function () {
    ...
    _oBallBody = new CANNON.Body({ mass: BALL_MASS, material: _oBallMaterial, linearDamping: BALL_LINEAR_DAMPING, angularDamping: BALL_LINEAR_DAMPING * 2 });
