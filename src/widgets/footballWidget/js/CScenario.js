function CScenario() {
    ...
    for (var i = 0; i < NUM_AREA_GOAL.h; i++) {
      for (var j = 0; j < NUM_AREA_GOAL.w; j++) {
        s_oScenario.createAreaGoal(
          { x: fX, y: FIRST_AREA_GOAL_POS.y, z: fZ },
  ...
  this._createGoal = function () {
    _oPoleGoalShapeLeftRight = new CANNON.Cylinder(
    ...
    _oPoleGoalShapeUp = new CANNON.Cylinder(
    ...
    _oGoalBodyPoleLeftRight.addShape(
      _oPoleGoalShapeLeftRight,
      new CANNON.Vec3(POLE_UP_SIZE.height * 0.5, 0, 0),
    );
    _oGoalBodyPoleLeftRight.addShape(
      _oPoleGoalShapeLeftRight,
      new CANNON.Vec3(-POLE_UP_SIZE.height * 0.5, 0, 0),
    ...
    _oGoalBodyPoleLeftRight.addShape(
      _oPoleGoalShapeUp,
      new CANNON.Vec3(0, 0, POLE_RIGHT_LEFT_SIZE.height * 0.5),
    );
    _oGoalBodyPoleLeftRight.position.set(
  ...
  this.createBackGoalWall = function () {
    _oGoalShapeBackWall = new CANNON.Box(
      new CANNON.Vec3(
    ...
    _oGoalShapeLeftRightWall = new CANNON.Box(
      new CANNON.Vec3(
    ...
    _oGoalShapeUpWall = new CANNON.Box(
    ...
    _oGoalBodyWall.addShape(
      _oGoalShapeLeftRightWall,
      new CANNON.Vec3(BACK_WALL_GOAL_SIZE.width, 0, 0),
    );
    _oGoalBodyWall.addShape(
      _oGoalShapeLeftRightWall,
      new CANNON.Vec3(-BACK_WALL_GOAL_SIZE.width, 0, 0),
  ...
  this.createAreaGoal = function (oPos, oProperties, oColor, oInfo) {
    var oGoalShapeLine = new CANNON.Box(
      new CANNON.Vec3(oProperties.width, oProperties.depth, oProperties.height),
    );
