...
var NUM_SPRITE_GOALKEEPER = [24, 34, 34, 51, 25, 34, 34, 25, 30, 30, 30, 30, 51, 51, 36, 36];
...
var ORIGIN_POINT_IMPACT_ANIMATION = [
  ...
  { x: 334.5, y: /*95*/ null },
  { x: 4.8, y: /*3.76*/ null },
  { x: -198.77, y: /*40.5*/ null },
  { x: 189, y: /*22*/ null },
  { x: -208.4 /*null*/, y: /*-88*/ null },
  { x: 189, y: /*-75*/ null },
  { x: -150, y: /*84*/ null },
  { x: 101.8, y: /*95*/ null },
  { x: -344, y: -88 },
...
var AREA_GOALS_ANIM = [LEFT_UP, SIDE_LEFT_UP, CENTER_UP, SIDE_RIGHT_UP, RIGHT_UP, LEFT, SIDE_LEFT, CENTER, SIDE_RIGHT, RIGHT, LEFT_DOWN, SIDE_LEFT_DOWN, CENTER_DOWN, SIDE_RIGHT_DOWN, RIGHT_DOWN];
...
var FIRST_AREA_GOAL_POS = { x: -14 - AREA_GOAL_PROPERTIES.width * 0.5, y: BACK_WALL_GOAL_POSITION.y - UP_WALL_GOAL_SIZE.depth + 1.1, z: 3.1 - AREA_GOAL_PROPERTIES.height * 0.5 };
