...
class StartWidget {
  ...
  startAnimation = () => {
    ...
    animationEl.innerHTML = `
          <div class='position-relative product-design-bg-2 Preview-select' style='display:none;min-width: 200px; padding: 30px 22px;position:relative;box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.2); border: 1px solid #ddd' id='start_widget'>
