...
export class CompetitionScoreTableContainer {
  ...
  render() {
    ...
    <div style="width: 100%; height: 100%; position: relative; background: linear-gradient(0deg, 0%, 100%);backdrop-filter: blur(10px)">
      <div style="width:100%;top: 52px; position: absolute; text-align: center; color: ${
        this.prop === 'barbora' ? '#3BAF29' : 'white'
      }; font-size: 48px; font-family: Oswald; font-weight: 900; text-transform: uppercase; word-wrap: break-word" id="boomio-competition-scoreboard-name">Scoreboard</div>
    ...
    containerDiv.innerHTML += `
      ...
      <div style="width: calc(100% - 40px);margin-left:20px;margin-right:20px;top:590px;position:absolute; height: 46px; background: ${
        ...
        } ; font-size: 24px; font-family: Georama; font-weight: 700; line-height: 24px; word-wrap: break-word ">PLAY AGAIN</div>
      </div>
    </div>`;
