      ...
      ${
        ...
        (this.language === 'EN' && this.customer.includes('demo'))
          ? `<div id="boomio-title-win" style="width:100%; top: ${
              ...
              this.customer === 'Pigu.lt' ? '16px' : fontSize
          ...
          : ''
            ...
            <div id="boomio-text-win" style="width:calc(100% - 20px);margin-left:10px; top: ${
                                                            ...
                                                            : this.language === 'LT'
                                                              ...
                                                              : this.language === 'LV'
                                                                ...
                                                                : this.language === 'ET'
                                                                  ...
                                                                  : 'If you win any prizes, we will notify you via the email address you provided.'
            }</div>
              <div style="width:100%; top: ${
                ...
                this.customer.includes('demo') || this.language === 'EN' ? 'Congrats! Here’s your discount code – just for you!' : ''
              }</div>
            <div style="width:100%; top: 546px; position: absolute; text-align: center; color: ${textColor}; font-size: 10px; font-family: Montserrat; font-weight: 700; text-transform: uppercase; word-wrap: break-word">${
              this.customer === 'Eurovaistine' ? 'Uzvarētāji tiks informēti e-pastā.' : this.customer === 'Fantazijos' ? 'GAUK 19% NUOLAIDĄ VISKAM!' : ''
            } </div> `
