  ...
  createTestDiv() {
    ...
    containerDiv.innerHTML = `
      ...
      <div style="width: 379px; padding-top: 11px; padding-bottom: 11px; left: 27px; top: 430px; position: absolute; background: white; box-shadow: -4px -4px 8px #DFE6F5 inset; border-radius: 35px; overflow: hidden; justify-content: center; align-items: center; gap: 10px; display: inline-flex">
        <div style="text-align: center; color: #FF3183; font-size: 24px; font-family: Georama; font-weight: 700; line-height: 24px; word-wrap: break-word" id="boomio-competition-confirm-field">OK</div>
      </div>
      <div style="left: 28px; top: 353px; position: absolute; justify-content: center; align-items: center; gap: 5px; display: inline-flex">
        ...
        <div style="width: 20px; height: 20px; left: 0px; top: 0px; position: absolute;"><img src="${checkIcon}"></div>
      ...
      <input class="boomio-competition-input-field" type="text" style="border:none;width:329px;position: absolute; left: 51px; top: 299px; opacity: 0.60; text-align: start; color: #473F4E; font-size: 20px; font-family: Londrina Solid; font-weight: 300; line-height: 24px; word-wrap: break-word" placeholder="Your email address">
      <input  class="boomio-competition-input-field" type="text" style="border:none;width:329px;position: absolute; left: 51px; top: 215px; opacity: 0.60; text-align: start; color: #473F4E; font-size: 20px; font-family: Londrina Solid; font-weight: 300; line-height: 24px; word-wrap: break-word" placeholder="Player name">
      `;
