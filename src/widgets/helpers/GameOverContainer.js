...
export class GameOverContainer {
  createGameOverContainerDiv() {
    ...
    <div style="height: 100%; position: relative;  background: white; border-top-left-radius: 30px; border-top-right-radius: 30px; backdrop-filter: blur(10px)">
        ...
        <div style="left: 240px; top: 116px; position: absolute; color:  #3BAF29; font-size: 18px; font-family: Oswald; font-weight: 700; line-height: 27px; word-wrap: break-word;text-align:right;width:120px;" id="bestScoreField"></div>
        ...
        <div style="left: 240px; top: 150px; position: absolute; color:  #3BAF29; font-size: 18px; font-family: Oswald; font-weight: 700; line-height: 27px; word-wrap: break-word;text-align:right;width:120px;line-height:28px;" id="currentScoreField"></div>
        ...
        <div style="left: 240px; top: 185px; position: absolute; color:  #3BAF29; font-size: 18px; font-family: Oswald; font-weight: 700; line-height: 27px; word-wrap: break-word;text-align:right;width:120px;" id="bestScoreFieldConverted"></div>
