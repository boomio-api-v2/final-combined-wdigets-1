...
export class IkeaScoreTableContainer {
  ...
  updateVisuals() {
    ...
    <div style="width:100%;margin-top:20px;text-align: start; color: white; font-size: 42px; font-family: Montserrat; font-weight:800; text-transform: uppercase; word-wrap: break-word"> 
    ${userPercentageDiscount ?? 0}% </div>
        <div style="letter-spacing: -0.3px;margin-top:10px;line-height: 150%;width:100%;text-align: start; color: white; font-size: 12px; font-family: Montserrat; font-weight:400; word-wrap: break-word;"> 
   Nuolaida jūsų pirkinių krepšeliui, perkant už 50 € 
ar daugiau.</div>

    <div style="letter-spacing: -0.3px;line-height: 150%;margin-bottom:15px;width:100%;margin-top:10px; text-align: start; color: white; font-size: 10px; font-family: Montserrat; font-weight:400; word-wrap: break-word;"> 
    ...
    let fontWeight =
      ...
      this.prop === 'LemonGym'
        ...
        : '700';
    let scoreboardText = `
     <div style="width:100%; top: 430px;margin-top:10px; position: absolute; text-align: center; color: white; font-size: 14px; font-family: Montserrat; font-weight: ${fontWeight}; text-transform: uppercase; word-wrap: break-word">Pagerink rezultatą, nes surinkus daugiau nei</br><div style='font-weight:500'> 2000 taškų laimėsi nuolaidą!</div></div>
             </div>
    ...
    TAVO REZULTATAS:  ${this.currentScore ?? 0} </div>
      <div style="width:100%;top: 85px; position: absolute; text-align: center; color: ${
        ...
        this.prop === 'LemonGym'
          ? 'white'
          : 'white'
      }; font-size: 40px; font-family: Montserrat; font-weight: 900; ; word-wrap: break-word" id="boomio-collection-scoreboard-name">${
