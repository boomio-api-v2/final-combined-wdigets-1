...
export class RulesContainer {
  ...
  updateVisuals() {
    ...
    <p>5.&nbsp;&nbsp;&nbsp;Kiekvieną savaitę, dešimt daugiausiai taškų pasiekusių žaidimo dalyvių laimės 20€ vertės dovanų kuponus.</p>

    <p>5.1.&nbsp;&nbsp;Žaidimo dovaną žaidimo dalyvis gali gauti tik vieną kartą per 28 dienas nuo žaidimo laimėtojų paskelbimo, kurio datos pateiktos taisyklių 6.1. punkte. Jei tarp dešimties geriausių žaidėjų patenka žaidimo dalyvis, kuris jau gavo žaidimo dovaną per paskutines 28 dienas, jo dovana perleidžiama kitam žaidėjui, surinkusiam daugiausiai žaidimo taškų.</p>
    ...
    <p>7.2.&nbsp;&nbsp;Dovanų kuponas negrąžinamas bei į pinigus nekeičiamas;</p>
    ...
    <p>8.&nbsp;&nbsp;Nustačius nesąžiningą žaidimo dalyvio elgesį, Akcijos organizatorius pasilieka teisę žaidimo dalyvį pašalinti iš žaidimo be išankstinio pranešimo.</p>

    <p>9.&nbsp;&nbsp;Visi ginčai, kylantys dėl žaidimo, yra sprendžiami derybų būdu. Jei susitarimo nepavyksta pasiekti derybomis, ginčai yra sprendžiami Lietuvos teisme Lietuvos Respublikos įstatymų nustatyta tvarka pagal Akcijos organizatoriaus buveinės vietą.</p>

    <p>10.&nbsp;&nbsp;Akcijos organizatorius turi teisę vienašališkai nutraukti žaidimą ir panaikinti prizus dėl nenugalimos jėgos aplinkybių (force majeure) iš karto po to, kai dalyviai informuojami apie žaidimo nutraukimą viešai.</p>

    <p>11.&nbsp;&nbsp;Akcijos organizatorius turi teisę be išankstinio įspėjimo vienašališkai keisti ar papildyti šias Žaidimo taisykles, apie tai žaidimo dalyvius informuodamas <a href="https://pigu.lt/lt/t/zaidimo-taisykles-jump">https://pigu.lt/lt/t/zaidimo-taisykles-jump</a> puslapyje.</p>

    <p>12.&nbsp;&nbsp;Akcijos organizatorius įsipareigoja užtikrinti jam perduotų asmens duomenų saugumą ir neperduoti jų tretiesiems asmenims, išskyrus atvejus, kai to duomenų pateikimas būtinas pagal teisės aktų reikalavimus.</p>

    <p>13.&nbsp;&nbsp;Apriboti Jūsų asmens duomenų tvarkymą ir/ar įgyvendinti Jūsų kaip asmens duomenų subjekto teises Jūs galite šiais būdais:</p>
...
`
    ...
    <p>5.&nbsp;&nbsp;&nbsp;Every week, the ten game participants who score the most points will win gift vouchers worth 20€.</p>

    <p>5.1&nbsp;&nbsp;A Participant may only receive a Game Prize once within 28 days of the announcement of the winners of the Game, the dates of which are set out in clause 6.1. If a Player who has already received a Game Prize in the last 28 days is in the top 10 players, their Game Prize will be transferred to the next highest scoring Player in the game.</p>
    ...
    <p>11.&nbsp;&nbsp;The Promotion Organizer has the right to unilaterally change or supplement these Game Rules without prior notice, informing the game participants about it on the <a href="https://pigu.lt/lt/t/zaidimo-taisykles">https://pigu.lt/lt/t/zaidimo-taisykles</a> page.</p>
    ...
    <p>- by contacting us by e-mail: <a href="mailto:duomenuapsauga@pigu.lt">duomenuapsauga@pigu.lt</a>;</p>
...
`
    ...
    <p>5.&nbsp;&nbsp;&nbsp;Katru nedēļu desmit spēles dalībnieki, kuri iegūst visvairāk punktu, laimēs 220.lv dāvanu kartes 20 eiro vērtībā.</p>

    <p>5.1&nbsp;&nbsp;Dalībnieks var saņemt Spēles balvu tikai vienu reizi 28 dienu laikā pēc Spēles uzvarētāju paziņošanas, noteiktajos datumos 6.1. punktā. Ja Spēlētājs, kurš pēdējo 28 dienu laikā jau ir saņēmis Spēles balvu, ir starp 10 labākajiem spēlētājiem, viņa Spēles balva tiks nodota nākamajam augstāko punktu skaitu ieguvējam spēlē.</p>
...
`
    ...
    <p>4.&nbsp;&nbsp;&nbsp;The game is played on the 220.lv mobile app. During the game, the game participant controls the game hero, whose goal is to avoid hitting obstacles while flying. To improve the result, the game participant can repeat the game.</p>
    ...
    <p>6.1.&nbsp;&nbsp;The game participant is informed about the game prize specified in clause 5 of the Game Rules at the e-mail address provided by him. Information about winning the previous week's game is sent on Mondays, on the following dates: November 25, 2024, December 2, 2024, December 9, 2024, December 16, 2024, December 23, 2024, December 30, 2024, January 6, 2025, January 13, 2025, January 20, 2025, January 27, 2025, February 3, 2025.</p>
    ...
    <p>- by contacting us by e-mail: <a href="mailto:datuaizsardziba@220.lv">datuaizsardziba@220.lv</a>;</p>

    <p>- by contacting us by phone: +371 60001472.</p>
...
`
    ...
    <p>5.&nbsp;&nbsp;&nbsp;Igal nädalal võidavad kümme enim punkte kogunud mängus osalejat kinkekaardid väärtusega 20€.</p>

    <p>5.1&nbsp;&nbsp;Osaleja võib saada mängu auhinna ainult üks kord 28 päeva jooksu, alates mängu võitjate väljakuulutamisest, mille kuupäevad on sätestatud punktis 6.1. Kui mängija, kes on viimase 28 päeva jooksul juba võitnud auhinna ning on 10 parima mängija hulgas, kantakse tema auhind üle järgmisele mängus kõige rohkem punkte saanud mängijale.</p>
    ...
    <p>7.&nbsp;&nbsp;&nbsp;Mängu kinkekaartide kasutustingimused:</p>
    ...
    <p>- võtates meiega ühendust e-posti teel: <a href="mailto:andmekaitse@kaup24.ee">andmekaitse@kaup24.ee</a>;</p>

    <p>- võtates meiega ühendust telefoni teel: +372 6 468 107.</p>
...
`
    ...
    <p>5.&nbsp;&nbsp;&nbsp;Каждую неделю десять участников игры, набравших наибольшее количество очков, будут выигрывать подарочные карты на сумму 20 евро.</p>
    ...
    <p>- связавшись с нами по электронной почте: <a href="mailto:duomenuapsauga@pigu.lt">duomenuapsauga@pigu.lt</a></p>

    <p>- связавшись с нами по телефону: +370 52073998.</p>
...
`
    ...
    <p>- связавшись с нами по электронной почте: <a href="mailto:andmekaitse@kaup24.ee">andmekaitse@kaup24.ee</a></p>

    <p>- связавшись с нами по телефону: +372 6 468 107.</p>
...
`
    ...
    <p>5.1.&nbsp;&nbsp;Viikoittain kymmenen eniten pisteitä saanutta osallistujaa voittaa 20€:n lahjakortin.</p>

    <p>5.1&nbsp;&nbsp;Osallistuja voi saada pelipalkinnon vain kerran 28 päivän aikana. Aikaraja lasketaan siitä, kun pelin voittajat on julkistettu ehtojen kohdassa 6.1. määritellyn mukaisesti. Jos pelaaja, joka on jo saanut pelipalkinnon viimeisten 28 päivän aikana, on 10 parhaan pelaajan joukossa, hänen pelipalkintonsa siirretään seuraavaksi eniten pisteitä keränneelle pelaajalle.</p>
...
`
    ...
    <p>- by contacting us by e-mail: <a href="mailto:asiakaspalvelu@hobbyhall.fi">asiakaspalvelu@hobbyhall.fi</a></p>

    <p>- by contacting us by phone: 09 8566 8000.</p>
