          ...
          ? `<div style="width:100%; top: ${'390px'}; position: absolute; text-align: center; color: ${textColor}; font-size: ${
            ...
            <div style="width:100%; top: ${'420px'};line-height:18px; position: absolute; text-align: center; color: ${textColor}; font-size:${
              ...
              this.prop === 'Barbora'
                ...
                : this.prop === 'Pigu.lt' && this.language === 'ET'
                ? `Iga nädal võidavad 10 parimat mängijat auhindu! </br>Võidu korral teavitame Sind e-mailiga, millega oled oma konto registeerinud.</br></br> ${
                    this.prop === 'Pigu.lt'
          ...
          : `<div style="width:100%; top: 390px; position: absolute; text-align: center; color: ${textColor}; font-size: ${fontSize}; font-family: Montserrat; font-weight: ${fontWeight}; text-transform: uppercase; word-wrap: break-word">${
            ...
            <div style="margin-left:20px;width:calc(100% - 40px); top: 420px;line-height:18px; position: absolute; text-align: center; color: ${textColor}; font-size:${
              ...
              this.prop === 'Barbora'
                ...
                : this.prop === 'Pigu.lt' && this.language === 'ET'
                ? `Paranda oma tulemust, sest 10 parimat mängijat võidavad iga nädal auhindu!</br>Võidu korral teavitame Sind e-mailiga, millega oled oma konto registeerinud.</br></br> ${
                    this.prop === 'Pigu.lt'
                      ? '<strong style="text-transform:uppercase">Valitud mänguasjadele ja moekaupadele <strong style="color:#DFFC38">lisaale -15%</strong> <strong id="startCodeRulesButtonClick" style="text-decoration:underline">koodiga*</strong></strong>'
                      : ''
                  }`
